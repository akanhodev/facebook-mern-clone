    ...
    return (
        <div className="header">
            <div className="header__left">
                ...
                <div className="header___searchInput">
                    <SearchIcon />
                    <input 
